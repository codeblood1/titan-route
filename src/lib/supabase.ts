...
function seedIfEmpty() {
  ...
  const samplePackages: Package[] = [
    ...
    },
    {
      ...
      fishAvatar: "voyager", status: "received", customStatusReason: null,
      mediaUrls: [],
    ...
    },
    {
      ...
      fishAvatar: "sky", status: "sent", customStatusReason: null,
      mediaUrls: [],
    ...
    },
    {
      ...
      fishAvatar: "swift", status: "canceled", customStatusReason: null,
      mediaUrls: [],
